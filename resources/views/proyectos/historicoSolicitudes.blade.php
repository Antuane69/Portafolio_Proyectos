        ...
        <div class="max-w-8xl mx-auto sm:px-8 lg:px-10">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                @if (session()->has('success'))
                    ...
                    <div class="alert alert-success auto-fade px-2 mt-4 inline-flex flex-row w-3/4 mb-2 text-green-600">
                        {{ session()->get('success') }}
                    </div> 
                @endif
                <div class="grid-rows content-center text-center justify-center my-8">
                    ...
                    @foreach ($solicitudes as $solicitud)                        
                        <div class="inline-flex break-words text-wrap content-center justify-center text-center pb-1" style="width: 90%;margin-bottom:30px;margin-top:30px;">
                            <div style="width: 16%;margin-right:0.5%" class="body-tabla">
                                <span style="margin-right: 5%">
                                    {{$solicitud->nombre}}
                                </span>
                            </div>
                            <div style="width: 10%;margin-left:1%;margin-right:1%" class="body-tabla">
                                <span>
                                    {{$solicitud->estatus}}
                                </span>
                            </div>
                            <div style="width: 30%;margin-left:2%;margin-right:1%" class="body-tabla">
                                <span style="padding-right:5%">
                                    {{$solicitud->requerimientos}}
                                </span>
                            </div>
                            <div style="width: 29%;margin-left:2%;margin-right:2%" class="body-tabla">
                                <span style="padding-left: 5%;padding-right:5%">
                                    {{$solicitud->comentarios}}
                                </span>
                            </div>
                            <div style="width: 15%;margin-left:1%;margin-right:1%" class="body-tabla">
