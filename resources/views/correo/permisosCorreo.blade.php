            ...
            <div>
                <div class="content-section">
                    ...
                    <p class="content-paragraph">
                        ...
                        @else
                            El presente correo es con intención de comunicar que su permiso ha sido Rechazado por Recursos Humanos, a fecha de {{$fecha}}.
                        @endif
                    </p>
                    ...
                    <div class="content-section">
                        ...
                        <p class="content-paragraph">
                            ...
                            @if (auth()->user()->hasRole('admin'))                                    
                                <p>
                                    <a href="{{ route('mostrarPermisos.show') }}" target="_blank" style="font-weight:bold;color:#0369a1">Ver la Solicitud en la Página.</a>
                                </p>
                            @endif
                        </p>
                    </div>
