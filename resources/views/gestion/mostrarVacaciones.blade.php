                        ...
                        @foreach ($vacaciones as $vacacion)
                            <tr>     
                                @if($vacacion->estado == 'Si')
                                    ...
                                    <td align="center" class="font-bold" style="background-color:#DCFFCA">{{ $vacacion->nombre_real }}</td>
                                ...
                                @elseif ($vacacion->estado == 'No')
                                    ...
                                    <td align="center" class="font-bold" style="background-color:#FFECEC">{{ $vacacion->nombre_real }}</td>
