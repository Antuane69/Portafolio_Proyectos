                ...
                <table id="data-table" class="stripe hover translate-table"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class='text-center'>Fecha Inicio de la Incapacidad</th>
                            <th class='text-center'>Fecha Regreso de la Incapacidad</th>
                            ...
                            <tr>                                    
                                ...
                                <td class=" px-2 py-1">
                                    <div class="in-line flex justify-center object-center">
                                        <button type="button" id="opcionesButton" class="rounded-md bg-gray-800 hover:bg-gray-600 text-white font-bold p-2" data-bs-toggle="modal" data-bs-target="#exampleModal_{{$incapacidad->id}}">Opciones</button>   
                                    </div>
                                    <div class="modal fade" id="exampleModal_{{$incapacidad->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content" style="width: 450px; height: 200px;">
                                                ...
                                                <div class="modal-body">
                                                    <div style="display: block; flex-direction: column; align-items: center;">
                                                        <div class="in-line flex justify-center object-center">
                                                            <form method="POST" action="{{ route('eliminarIncapacidad', ['id' => $incapacidad->id]) }}">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            <form action="{{ route('editarIncapacidad.show', $incapacidad->id) }}" method="GET" class="mb-2">
                                                                @csrf         
