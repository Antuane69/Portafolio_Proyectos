        ...
        <div class="mx-10 px-10 py-10 rounded-b-xl bg-gray-100 mb-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
                ...
                @elseif($selectedStatus == '13') <!--Si se solicita baja -->
                        <div class="grid grid-cols-1">
                            <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">*Dictamen:</label>
                                <input 
                                    name = "dictamen"
                                    style="border-color: rgb(21 128 61);"  
                                    type="file"
                        ...
                        <div class="grid grid-cols-1">
                            <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">*Formato 13:</label>
                                <input 
                                    name = "formato13"
                                    style="border-color: rgb(21 128 61);"  
                                    type="file"
