                            ...
                            <div class="justify-between mt-10 grid grid-cols-2 md:grid-cols-3 md:gap-5 mr-10">
                                ...
                                <div class='grid grid-cols-1'>
                                    ...
                                    <p class="inline-flex">
                                        ...
                                        <a href="" data-bs-toggle="modal" title="Cambiar Contraseña" data-bs-target="#exampleModal_password_{{$usuario->id}}" style="text-decoration: none;margin-top:3%">
                                    ...
                                    <form action="{{ route('perfil.delete',$usuario->id) }}" method="POST">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-1 gap-1 md:gap-2 mx-4">                    
                                            ...
                                            <div class="flex justify-between">
                                                <div class='grid grid-cols-1'>
                                                    <label for="password-delete" class="bloack uppercase font-bold" style="color:#1C0B49;height:50px;margin-right:19%">* Contraseña</label>
                                                    <div class="flex items-center">
                                                        <input id="password-delete" type="password" name="password" placeholder="ingrese su contraseña"
                                                        ...
                                                        <a class="ml-2" style='cursor:pointer'>
                                                            <div id="eye-open-delete" onclick="viewPassword('open','delete')">
                                                            ...
                                                            <div id="eye-closed-delete" hidden onclick="viewPassword('closed','delete')">
                                                                <svg class="h-7 w-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="black">
                                                ...
                                                <div class='grid grid-cols-1' style="margin-left:5%">
                                            ...
                                            <div class="grid grid-cols-1 mb-2">
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <a class="ml-2" style='cursor:pointer'>
                                                        ...
                                                        <div id="eye-closed-new" hidden onclick="viewPassword('closed','nueva')">
                                                            <svg class="h-7 w-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="black">
                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88" />
                                                            </svg>                                                                                                              
                                                        </div>
    ...
    function viewPassword(state,type){
        if(state == 'open'){
            if(type == 'actual'){
                ...
                document.getElementById('eye-open-delete').hidden = true;
                document.getElementById('eye-closed-delete').hidden = false;
                document.getElementById('password-delete').type = 'text';
            }
        }else{
            if(type == 'actual'){
                ...
                document.getElementById('eye-open-delete').hidden = false;
                document.getElementById('eye-closed-delete').hidden = true;
                document.getElementById('password-delete').type = 'password';
            }
        }
    }
