<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Registros de PDF de Uniformes Subidos') }}
        </h2>
    </x-slot>
                ...
                <table id="data-table" class="stripe hover translate-table"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class='text-center'>Tipo Uniforme</th>
                            <th class='text-center'>Código</th>
                            <th class='text-center'>Talla</th>
                            <th class='text-center'>Fecha de Subida al Sistema</th>
                            <th class='text-center'>Reporte de Uniforme Firmado</th>
                    ...
                    <tbody>
                        @foreach ($uniformes as $uniforme)
                            <tr>                                    
                                <td align="center" class="font-bold">{{ $uniforme->id }}</td>
