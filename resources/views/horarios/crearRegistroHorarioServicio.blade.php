<x-horarios>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight ml-10">
            {{ __('Asignación de Horario (Mesero/Servicio)') }}
        </h2>
    </x-slot>
        ...
        <div class="mx-auto sm:px-6 lg:px-8" style="width:100 rem;">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-6 mb-3" style="width:100%;">
                ...
                <form id="formulario" action={{ route('horario.store',$area) }} method="POST" enctype="multipart/form-data">
                    @csrf
                    <p class="ml-3 font-bold text-xl mt-6 text-center content-center justify-center mb-4">MESERO / SERVICIO</p>
                    <table id="data-table" class="stripe hover translate-table data-table pb-3 mb-4"
                        ...
                        <tbody>
                            ...
                            <tr>    
                                ...
                                @endif
                                <td align="center" class="font-bold">
                                    <select name="serviciolunes{{$k}}[]" class='form-control js-example-basic-multiple js-states' multiple="multiple"
                                        data-minimum-selection-length="{{$arregloServicio[$k]['lunes']}}">             
                                ...
                                <td align="center" class="font-bold">
                                    <select name="serviciomartes{{$k}}[]" class='form-control js-example-basic-multiple js-states' multiple="multiple"
                                        data-minimum-selection-length="{{$arregloServicio[$k]['martes']}}">             
                                ...
                                <td align="center" class="font-bold">
                                    <select name="serviciomiercoles{{$k}}[]" class='form-control js-example-basic-multiple js-states' multiple="multiple"
                                        data-minimum-selection-length="{{$arregloServicio[$k]['miercoles']}}">             
                                ...
                                <td align="center" class="font-bold">
                                    <select name="serviciojueves{{$k}}[]" class='form-control js-example-basic-multiple js-states' multiple="multiple"
                                        data-minimum-selection-length="{{$arregloServicio[$k]['jueves']}}">             
                                ...
                                <td align="center" class="font-bold">
                                    <select name="servicioviernes{{$k}}[]" class='form-control js-example-basic-multiple js-states' multiple="multiple"
                                        data-minimum-selection-length="{{$arregloServicio[$k]['viernes']}}">             
                                ...
                                <td align="center" class="font-bold">
                                    <select name="serviciosabado{{$k}}[]" class='form-control js-example-basic-multiple js-states' multiple="multiple"
                                        data-minimum-selection-length="{{$arregloServicio[$k]['sabado']}}">             
                                ...
                                @if ($aux == 1)                                    
                                    <td align="center" class="font-bold" rowspan="3">
                                        <select name="serviciodomingo{{$k}}[]" class='form-control js-example-basic-multiple js-states' multiple="multiple"
                                            data-minimum-selection-length="{{$arregloServicio[0]['domingo']}}">             
                                ...
                                @elseif ($k == 3)
                                    <td align="center" class="font-bold">
                                        <select name="serviciodomingo3[]" class='form-control js-example-basic-multiple js-states' multiple="multiple"
                                            data-minimum-selection-length="{{$arregloServicio[3]['domingo']}}">             
                                            @foreach($nombres_ser as $nombre8)
                    ...
                    <div class='flex items-center justify-center  md:gap-8 gap-4 pt-1 pb-5'>
                        <button type="submit" id="submitButton"
                            ...
                            >Crear Plantilla de Mesero/Servicio</button>
                    </div>
                </form>
                @else
                    <p class="ml-3 font-bold text-xl mt-6 text-center content-center justify-center mb-4 uppercase">No Se Puede Registrar otro Horario</p>
                    <p class="ml-3 font-bold text-xl mt-6 text-center content-center justify-center mb-4 text-gray-800">Ya se elaboró uno el dia <span class="text-red-700 font-bold">{{$nombres_ser}}</span> y el sistema no permite hacerlos con menos de 6 dias de diferencia.</p>
                @endif
            </div>
        </div>
    </div>
