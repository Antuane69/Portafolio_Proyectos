                ...
                <div class="grid-rows lineaSep content-center text-center justify-center my-8">
                    @foreach ($proyectos as $proyecto)                        
                        <div class="inline-flex break-words text-wrap text-justify pb-1" style="width: 90%;margin-bottom:30px;">
                            <div class="content-center items-center" style="width:30%;margin-right:3%;border-width:0.5px;border-radius:10px;border-color: #1C0B49;height:auto">
                                <img class='shadow-xl md:w-full' style="width: 380px; height: 170px;border-radius:15px" src="{{ asset('assets/' . $proyecto->imagen) }}" alt="Imagen del Proyecto">
                            </div>
                            <div style="width: 15%">
                                <p class="text-center">
